---
title: "Developed financial data manipulation and integration scripts"
tags: ["Python", "Google Sheets", "Currency Conversion", "Financial Analysis", "Data Integration"]
created: 2024-01-07
publish: true
---

## 📅 2024-01-07 — Session: Developed financial data manipulation and integration scripts

**🕒 00:30–23:40**  
**🏷️ Labels**: Python, Google Sheets, Currency Conversion, Financial Analysis, Data Integration  
**📂 Project**: Accounting  
...
### Key Activities
- Modified the `add_balance` function to handle multiple currencies within a unified [[DataFrame]], ensuring accurate running balance calculations.
- Developed a method to convert historical ARS values using the IPC dataset, implementing a [[Python]] function for currency conversion.
...
- Loaded data from Google Sheets into [[Python]] using the `gspread` library, including setting up Google Cloud credentials and resolving common errors.
- Addressed issues with empty cells in Google Sheets data using `[[pandas]]` for data cleaning.
- Calculated three-way accounting balances and developed a debt cancellation plan among family members.
