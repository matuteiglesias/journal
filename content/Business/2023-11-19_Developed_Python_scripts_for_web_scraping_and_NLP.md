---
title: "Developed Python scripts for web scraping and NLP"
tags: ["Python", "Web Scraping", "NLP", "Financial Services", "Political Analysis"]
created: 2023-11-19
publish: true
---

## 📅 2023-11-19 — Session: Developed Python scripts for web scraping and NLP

**🕒 03:00–07:00**  
**🏷️ Labels**: Python, Web Scraping, NLP, Financial Services, Political Analysis  
**📂 Project**: Business  



**Session Goal:**
The session aimed to develop and refine [[Python]] scripts for [[web scraping]] and natural language processing (NLP) tasks related to political speech analysis and financial account management.
