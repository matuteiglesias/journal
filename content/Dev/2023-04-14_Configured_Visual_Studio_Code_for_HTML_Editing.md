...
## 📅 2023-04-14 — Session: Configured Visual Studio Code for HTML Editing
...
### Session Goal
The session aimed to enhance HTML editing efficiency using Visual Studio Code's Split Editor feature and to address server-side operations for remote website management.
...
- Completed server-side operations for remote website management.

### Pending Tasks
- Investigate and resolve the domain name takeover issue for 'matiasdice.com' by considering legal action or registering a new domain.
- Set up a website with GoDaddy and AWS by purchasing a domain and hosting it using an EC2 instance.
