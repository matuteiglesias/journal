---
title: "Developed Mapbox style management and troubleshooting scripts"
tags: ["Python", "Mapbox", "API", "CORS", "SSH", "Troubleshooting"]
created: 2023-05-23
publish: true
---
...
**Session Goal:**
The session aimed to develop and troubleshoot scripts for managing Mapbox styles using [[Python]] and [[JSON]], and to address common [[web development]] and command-line issues.
