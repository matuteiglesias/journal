...
- Developed DBML schemas to define relationships between datasets related to individual income, household poverty, and geographical information.
- Addressed DBML reference conflicts and ensured unique references across tables.
- Proposed schema adaptations to include unique identifiers and composite primary keys for data integrity.
- Implemented HTML code for data set descriptions in Spanish and responsive image insertion using CSS.
