---
title: "Implemented n8n Workflow with GPT Integration"
tags: ["N8N", "Workflow", "GPT", "Automation", "Openai"]
created: 2024-12-12
publish: true
---

## 📅 2024-12-12 — Session: Implemented n8n Workflow with GPT Integration

**🕒 15:50–16:05**  
**🏷️ Labels**: N8N, Workflow, GPT, Automation, Openai  
**📂 Project**: Dev  
...
- Fixed the [[OpenAI]] [[API]] request [[configuration]] by correctly placing the `model` parameter in the body instead of the headers.
