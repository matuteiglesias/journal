---
title: "Developed Python Scripts for Financial Data Handling"
tags: ["Python", "Data Handling", "Financial Data", "Excel", "Pandas"]
created: 2025-07-05
publish: true
---

## 📅 2025-07-05 — Session: Developed Python Scripts for Financial Data Handling

**🕒 18:50–19:00**  
**🏷️ Labels**: Python, Data Handling, Financial Data, Excel, Pandas  
**📂 Project**: Dev  
...
- Checked file existence for crypto history export using [[Python]]'s `os.path.exists` method.
- Loaded Excel files and retrieved sheet names using [[pandas]], and read data into DataFrames for analysis.
