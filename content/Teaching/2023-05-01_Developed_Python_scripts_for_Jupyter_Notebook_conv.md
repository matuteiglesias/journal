---
title: "Developed Python scripts for Jupyter Notebook conversion"
tags: ["Python", "Jupyter", "NLP", "Data Processing", "Regex"]
created: 2023-05-01
publish: true
---
...
### Achievements
- Successfully created and tested [[Python]] scripts that convert `.py` files into [[Jupyter]] Notebook format, preserving structure and content.
- Developed practical exercises that apply [[data processing]] techniques in [[Python]], providing valuable resources for students.
